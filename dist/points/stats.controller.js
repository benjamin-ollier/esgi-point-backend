...
let StatsController = class StatsController {
    ...
    async getMemberStats(communityId, memberId) {
        if (!communityId || !memberId) {
            throw new common_1.NotFoundException('communityId and memberId are required');
        }
...
__decorate([
    (0, common_1.Get)(':communityId/:memberId'),
    __param(0, (0, common_1.Param)('communityId')),
    __param(1, (0, common_1.Param)('memberId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], StatsController.prototype, "getMemberStats", null);
